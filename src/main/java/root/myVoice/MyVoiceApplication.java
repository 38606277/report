...
//		}
	...
	@RequestMapping(value = "/yuyin", produces = "text/plain;charset=UTF-8")
	public String  yuyin(@RequestBody String pJson, HttpServletResponse response) throws Exception , IOException {
