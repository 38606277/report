...
public class QueryService {
    ...
    public String createFunctionName(SqlSession sqlSession, JSONObject jsonFunc) throws Exception {
        ...
        sqlSession.insert("query.createFunctionName", mapFunc);
     ...
     * 功能描述:   往query_in表插入数据
     */
    public void createFunctionIn(SqlSession sqlSession, JSONArray jsonArrayIn, String qry_id) {
        ...
        for (int i = 0; i < jsonArrayIn.size(); i++) {
            ...
            sqlSession.insert("query.createFunctionIn", map);
        }
    }
     ...
     */
    public void createFunctionOut(SqlSession sqlSession,JSONArray jsonArray,String qry_id) {
        Map<String, String> map = new HashMap<>();
        for (int i = 0; i < jsonArray.size(); i++) {
            ...
            sqlSession.insert("query.createFunctionOut", map);
        }
    }
    ...
    public int updateFunctionName(SqlSession sqlSession, JSONObject jsonFunc)
    {
        ...
        mapFunc.put("qry_file", jsonFunc.getString("qry_file"));
        mapFunc.put("qry_db", jsonFunc.getString("qry_db"));
        return sqlSession.update("query.updateFunctionName", mapFunc);
    }
    ...
    public int deleteFunctionIn(SqlSession sqlSession,Map map) {
        return sqlSession.delete("query.deleteFunctionIn", map);
    }
    ...
    public void deleteFunctionOut(SqlSession sqlSession,Map map) {
        sqlSession.delete("query.deleteFunctionOut", map);
    }
     ...
     */
    public void deleteFunctionName(SqlSession sqlSession,int qry_id) {
        sqlSession.delete("query.deleteFunctionName", qry_id);
    }

    /**
     * 功能描述: 针对传递进来的JSONAarray进行批量删除qry_in数据
     */
    public void deleteFunctionInForJsonArray(SqlSession sqlSession,int qry_id) {
        sqlSession.delete("query.deleteFunctionInByFuncId",qry_id);
    }

    /**
     * 功能描述: 针对传递进来的JSONAarray进行批量删除func_out数据
     */
    public void deleteFunctionOutForJsonArray(SqlSession sqlSession,int qry_id) {
        sqlSession.delete("query.deleteFunctionOutByFuncId",qry_id);
    }
